...
##Value used to limit the maximum distance the camera can be from it's target.
##General rule of thumb: set this to be close in value to parent's maximum step height value.
@export var lerp_clamp : float = 0.175
